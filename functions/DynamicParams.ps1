<#
	...
	DynamicParam { if ($source) { return (Get-ParamSqlXyz -SqlServer $Source -SqlCredential $SourceCredential) } }
...
Function Get-ParamSqlProxyAccount
{
<# 
 .SYNOPSIS 
 Internal function. Returns System.Management.Automation.RuntimeDefinedParameterDictionary 
...
#>	
	...
	$attributeCollection.Add($attributes)
	if ($list) { $attributeCollection.Add($validationset) }
	$ProxyAccount = New-Object -Type System.Management.Automation.RuntimeDefinedParameter("ProxyAccount", [String], $attributeCollection)
	
	$newparams.Add("ProxyAccount", $ProxyAccount)
	$server.ConnectionContext.Disconnect()
...
Function Get-ParamSqlServerInventory
{
<# 
 .SYNOPSIS 
 Internal function. Returns System.Management.Automation.RuntimeDefinedParameterDictionary 
...
#>	
	...
	$sql = "Select [ServerName], [InstanceName] FROM [$InstallDatabase].[dbo].[InstanceList]"
	$results = $server.ConnectionContext.ExecuteWithResults($sql)
	
	$attributeCollection = New-Object -Type System.Collections.ObjectModel.Collection[System.Attribute]
	$attributeCollection.Add($attributes)
	$attributeCollection.Add((New-Object System.Management.Automation.ValidateSetAttribute -ArgumentList $results.Tables.InstanceName))
	
	$Instance = New-Object -Type System.Management.Automation.RuntimeDefinedParameter("Instance", [String], $attributeCollection)
	$newparams.Add("Instance", $Instance)
	
	$attributeCollection = New-Object -Type System.Collections.ObjectModel.Collection[System.Attribute]
	$attributeCollection.Add($attributes)
	$attributeCollection.Add((New-Object System.Management.Automation.ValidateSetAttribute -ArgumentList $results.Tables.ServerName))
	
	$ServerName = New-Object -Type System.Management.Automation.RuntimeDefinedParameter("ServerName", [String], $attributeCollection)
	$newparams.Add("ServerName", $ServerName)
...
#>	
	...
	# Populate arrays
	$list = $server.JobServer.Jobs.Name | Where-Object { $_ -like '*dbareport*' }
